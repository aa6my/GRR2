...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2015 at 07:56 PM
...
`review_id` int(5) NOT NULL,
  ...
  `review_vote` int(5) NOT NULL DEFAULT '0'
...
INSERT INTO `reviews` (`review_id`, `game_id`, `user_id`, `review_title`, `review_story`, `review_gameplay`, `review_graphic`, `review_music`, `review_pro`, `review_contra`, `review_vote`) VALUES
(1, 1, 2, 'test title', 'Max Payne is a third-person shooter video game developed by Remedy Entertainment and published by Gathering of Developers on July 2001 for Microsoft Windows. Ports created later in the year for the PlayStation 2, Xbox and the Game Boy Advance were published by Rockstar Games. A Mac OS port was published on July 16, 2002 by MacSoft in North America and Feral Interactive in the rest of the world.[2] There were plans for a Dreamcast version of Max Payne, but they were canceled due to the discontinuation of the console.[5] The game was re-released on April 27, 2009 as a downloadable game in the Xbox Originals program for the Xbox 360.[6] The game was also re-released in the spring of 2012 as a downloadable game in the PlayStation Store for the PlayStation 3 under the PS2 classics banner, iOS and on Android.', 'two', 'three', 'five', 'good', 'bad', 3),
(2, 2, 2, 'hjkhjk', '<p>\r\n	fdghfg</p>\r\n', 'three', 'four', 'one', '<p>\r\n	yuiyiy</p>\r\n', '<p>\r\n	jklhkljhkljhkl</p>\r\n', 0),
(3, 1, 2, 'asdasd', 'sdefsdf', 'three', 'four', 'two', 'wewsed', 'sdfsdf', 3),
(7, 2, 2, 'nnnn', 'dfgdg', 'three', 'five', 'four', 'try', 'dffd', 4),
(8, 2, 2, 'vbvb4545', 'dfgdfg', 'one', 'four', 'two', 'ae', 'yuy', 2),
(9, 2, 2, 'cvcvcvc4444', 'sdfdsf', 'two', 'three', 'five', 'bbbb', 'adsfsdf', 1);
...
(2, 'adminah@admin.com', '8e666f12a66c17a952a1d5e273428e478e02d943', '4f6cdddc4979b8.51434094', 1, '2015-02-23 19:52:35', '::1', NULL, NULL, NULL, 1, 1, 'Panda_Icon_by_cheepers.gif');
...
--
ALTER TABLE `reviews`
MODIFY `review_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
